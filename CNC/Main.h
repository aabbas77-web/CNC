...
public:		// User declarations
	...
	void __fastcall Extract_Template();
    ...
    int m_nLanguageID;
    double m_dWorkingAreaWidthCM;// CM
    double m_dWorkingAreaHeightCM;
    double m_dMinStepCM;

    // Grid
    double m_dGridOX,m_dGridOY,m_dGridSmallStepX,m_dGridSmallStepY;
